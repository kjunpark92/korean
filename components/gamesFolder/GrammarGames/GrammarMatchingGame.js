...
class GrammarMatchingGame extends React.Component {
  constructor(props){
    super(props);
  ...
  //Return & Display the buttons for each grammar Point
  grammarMatchingBoxes = () => {
  ...
  englishWordAnswer = () => {
    ...
    if(answersArray[this.state.questionNumber].length < 3){
      ...
      return (
        answersArray[this.state.questionNumber][this.props.gameAnswer].short_explanation
      )
    }
  }
  ...
  koreanWordAnswer = () => {
    ...
    if(answersArray[this.state.questionNumber].length < 3){
      ...
      return answersArray[this.state.questionNumber][this.props.gameAnswer].grammar_point
    }
  }
  ...
  gamePlay = () => {
    ...
    return (
      <div>
        ...
        {this.state.playing ? <div className={pauseHide} id="gameMatchingAnswers">{this.grammarMatchingBoxes()}</div> : null}
...
export default connect(mapStateToProps)(GrammarMatchingGame);