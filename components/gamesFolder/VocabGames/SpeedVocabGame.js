...
class SpeedVocabGame extends React.Component {
  constructor(props){
    super(props);
  ...
  renderTime = ({ remainingTime }) => {
    ...
    if (remainingTime === 0 && this.state.playing === false) {
      return <div className="gameTimer"><h2>Game Over!</h2></div>;
    } else if (remainingTime === 0) {
      return <div className="gameTimer"><h2>Times Up!</h2></div>;
    ...
    return (
      <div className="gameTimer">
        <div className="gameTimerText"><p>Time:</p></div>
        <div className="gameTimerValue"><p>{remainingTime}</p></div>
      </div>
    );
  };
...
export default connect(mapStateToProps)(SpeedVocabGame);
