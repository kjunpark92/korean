...
class SpellingGame extends React.Component {
  constructor(props){
    super(props);
  ...
  koreanWordAnswer = () => {
    ...
    return (
      answersArray[this.state.questionNumber].korean
    )
  }
  ...
  englishWordAnswer = () => {
    const answersArray = this.props.items;
    return (
      answersArray[this.state.questionNumber].english
    )
  }
        ...
        {this.props.gameState === "Playing" ? 
          ...
          <div className="mainGameContent" id="spellingContent">
            <div className="gameTopContent">
              <h4>Spell the Korean word correctly!</h4>
                <div>
...
export default connect(mapStateToProps)(SpellingGame);