...
import {chunkArray, gameLengthening, shuffle, getOptionsData} from '../gameFunctions';
import DragDropGame from './DragDropGame';
import {Helmet} from 'react-helmet';
import VocabLearning from './VocabLearning';
import GetURLParams from "components/general/GetURLParams";

class DragDropGameView extends React.Component {
  constructor(props){
    super(props);
    this.state ={
      gameName: 'DragDrop Vocab',
      learningVocab: [{}],
      vocabulary: [{}],
      units: '0',
    }
  ...
  gameSelect = () => {
    ...
    return (
      <div className="gameSelectSection">
        <h2>Match the Korean word to the English word</h2>
        <form>
  ...
  render() {
    ...
    return(
      <div className="gameViewContainer">
        {/* Meta tags */}
        <Helmet>
          <title>Raw Korean - Drag Drop Game</title>
          ...
          {/* Open Graph */}
          <meta property="og:title" content="Raw Korean - Drag Drop Game" />
          <meta property="og:type" content="game" />
          <meta property="og:url" content="http://www.rawkorean.com/GamesRouter/DragDropGameView?level=1" />
        ...
        <div className="gameContainer">
          <header>
            ...
            {this.props.gameState === "Playing" ?  <DragDropGame gameName={this.state.gameName} level={level} items={this.state.vocabulary}/> : null}
...
export default connect(mapStateToProps)(DragDropGameView);
